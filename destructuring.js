...
const [connectionOne, connectionTwo] = connectivity;

console.log(connectionOne, connectionTwo);
...
const [firstNumber, , secondNumber] = tvSizes;
...
const [yourName, yourAge] = getDetails('Dylan', 27);
